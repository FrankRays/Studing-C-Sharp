...
namespace Platformer
{
    ...
    class Player
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (!(fire == null))
            {
                fire.Update(gameTime, (int)position.X);
                if (fire.dead) fire = null;
            }

            if (!HP.canTakeDmg)
            {
                if (level.TimeRemaining.Seconds - time == -3)
                {
                    HP.canTakeDmg = true;
                }
            }
        ...
        private void GetInput()
        {
            ...
            if (fire == null)
            {
                if (keyboardState.IsKeyDown(Keys.E))
                    fire = new Fire(level, position, 10);
        ...
        /// </param>
        public void OnKilled(Enemy killedBy, int dmg)
        {
            HP.TakeDmg(dmg);
            HP.canTakeDmg = false;
            time = level.TimeRemaining.Seconds;
            if (HP.health == 0)
            {
                isAlive = false;
        ...
        public void Draw(GameTime gameTime, SpriteBatch spriteBatch)
        {
            ...
            // Draw that sprite.
            sprite.Draw(gameTime, spriteBatch, Position, new SpriteEffects());
            if (!(fire == null)) 
