...
namespace ELW.Library.Math.Tools
{
    ...
    {
        List<VariableValue> ConstansValues;

        private void InitializeConstans()
        {
            ConstansValues = new List<VariableValue>();
            ConstansValues.Add(new VariableValue(3.14159265359, "pi"));
        }
        ...
        public double Calculate(CompiledExpression compiledExpression, List<VariableValue> variableValues)
        {
            ...
            InitializeConstans();
            variableValues.AddRange(ConstansValues);
